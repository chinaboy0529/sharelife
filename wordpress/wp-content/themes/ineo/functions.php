...
<form action="#" method="post" enctype="multipart/form-data" name="inove_form" id="inove_form">
	<div class="wrap">
		...
		<table class="form-table">
			<tbody>
				<tr valign="top">
					<th scope="row">';_e('相关文章','inove');;echo '</th>
					<td>
						<label>
							<input name="wumii_is_enabled" type="checkbox" value="checkbox" ';if($options['wumii_is_enabled']) echo "checked='checked'";;echo ' />
							 ';_e('启用无觅相关文章插件','inove');;echo '						</label><br/>
						';_e('设置无觅相关文章展示样式请登录：<a href=\"http://www.wumii.com/site/index.htm\">无觅网站管理中心</a>','inove');;echo '					</td>
				</tr>
			</tbody>
		</table>
			...
			<tbody>
				<tr valign="top">
					...
					<td>
						...
						<br />
						<div>
							';_e('Default Social.','blocks');;echo '							<select name="social_name" size="1">
								...
								<option value="tencent" ';if($options['social_name'] == 'tencent') echo ' selected ';;echo '>';_e('Tencent','blocks');;echo '</option>
								<option value="douban" ';if($options['social_name'] == 'douban') echo ' selected ';;echo '>';_e('Douban','blocks');;echo '</option>
							</select>
						</div>
						 ';_e('Sina URL:','inove');;echo '						 <input type="text" name="sina_url" id="sina_url" class="code" size="40" value="';echo($options['sina_url']);;echo '">
						<br />
						 ';_e('Twitter URL:','inove');;echo '						 <input type="text" name="twitter_url" id="twitter_url" class="code" size="40" value="';echo($options['twitter_url']);;echo '">
						<br />
						 ';_e('Tencent URL:','inove');;echo '						 <input type="text" name="tencent_url" id="tencent_url" class="code" size="40" value="';echo($options['tencent_url']);;echo '">
						<br />
						 ';_e('Douban URL:','inove');;echo '						 <input type="text" name="douban_url" id="douban_url" class="code" size="40" value="';echo($options['douban_url']);;echo '">
						<br />
...
;echo '	<li class="hreview clearfix ';if($comment->comment_author_email == get_the_author_email()) {echo 'admincomment';}else {echo 'evencomment';};echo '" id="comment-';comment_ID() ;echo '">
		<div class="info clearfix">
			...
			<div class="dtreviewed">';printf( __('%1$s at %2$s','inove'),get_comment_time(__('F jS, Y','inove')),get_comment_time(__('H:i','inove')) );;echo '';if (function_exists('useragent_output_custom')) {printf(' | ');echo useragent_output_custom();};echo '</div>
		</div>
